...
class TestConSub(unittest.TestCase):
    ...
    def testComputation_8_8(self):
        ...
        for i in range(256):
            ...
            self.assertEqual(self.im8_2.getPixel((0,0)), 255-i)
        ...
        self.assertEqual(self.im8_2.getPixel((0,0)), 255, "%d/255" % (self.im8_2.getPixel((0,0))))
    ...
    def testComputation_8_32(self):
        ...
        for i in range(1000):
            ...
            if (255-i < 0):
                ...
                exp_val = 255-i
            self.assertEqual(self.im32_2.getPixel((0,0)), exp_val)
